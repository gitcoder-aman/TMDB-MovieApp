...
public class MovieFragTrendingPopularRatedAdapter extends RecyclerView.Adapter<MovieFragTrendingPopularRatedAdapter.viewHolder> {
    Context context;
    List<TrendingPopularTopRatedMovieResultModel> trendingPopularTopRatedMovieResultModelsList;

    public MovieFragTrendingPopularRatedAdapter(Context context, List<TrendingPopularTopRatedMovieResultModel> trendingPopularTopRatedMovieResultModelsList) {
    ...
    @NonNull
    @Override
    public MovieFragTrendingPopularRatedAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.video_rv_layout, parent, false);
        return new viewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MovieFragTrendingPopularRatedAdapter.viewHolder holder, int position) {
        ...
        if (trendingMovieVideoModel != null) {
            ...
            if(trendingMovieVideoModel.getMedia_type() != null){
                holder.movie_type.setText(trendingMovieVideoModel.getMedia_type());
                holder.movie_type.setVisibility(View.VISIBLE);
            }
