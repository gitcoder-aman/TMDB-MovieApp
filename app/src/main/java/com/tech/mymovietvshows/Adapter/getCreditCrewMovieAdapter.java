            ...
            holder.favBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (holder.favBtn.getText().toString().equals("Watchlist")) {
                        ...
                        databaseHelper.movieTVDAO().addTx(new MovieTV(movie_id, posterImage, rating, movieName, releaseDate,"movie"));
                        ...
                        databaseHelper.movieTVDAO().deleteTx(new MovieTV(movie_id, posterImage, rating, movieName, releaseDate,"movie"));
