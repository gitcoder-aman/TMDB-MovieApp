...
import static com.tech.mymovietvshows.Fragment.Section.TrendingFragment.trendingRecyclerView;
...
public class HomeFragment extends Fragment {
    ...
    public static LinearLayoutCompat homeLayout;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        progressBarHome = view.findViewById(R.id.progressHome);
